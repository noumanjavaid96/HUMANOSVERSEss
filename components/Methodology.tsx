      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 text-left">
        <div className="bg-white p-8 rounded-lg border border-gray-200">
            <div className="flex items-center gap-3">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Agile/Scrum Approach</h3>
            </div>
            ...
            <p className="mt-4 text-gray-600 font-semibold text-cyan-600">
        ...
        <div className="bg-white p-8 rounded-lg border border-gray-200">
            <div className="flex items-center gap-3">
                 <span className="text-3xl">💬</span>
                <h3 className="text-2xl font-bold text-gray-900">Communication Plan</h3>
            </div>
            <p className="mt-4 text-gray-600">
            ...
            <ul className="mt-4 space-y-2">
                {communicationChannels.map((channel, index) => (
                    <li key={index} className="flex items-start">
                        <svg className="w-5 h-5 text-cyan-600 mt-1 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
